...
- **tea_and_murder** — pack-level rename from `victoria` completed 2026-05 across all repos. `glenross` (Highland village Edwardian Scotland c. 1908) is the live world; `blackthorn_moor` parked in workshopping pending M2 review.

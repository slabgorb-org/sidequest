...
- **Jade** (introduced to the group by Sebastien; not previously known to Keith) — A long-time DM in her own right: like Keith, a **forever-GM who also wants to play along**. With Sebastien she ran the 5-hour, 140+ turn `coyote_star` session — *while the confrontation engine was broken* — and carried it on narrative, NPC, and relationship strength alone. She and Sebastien are the group's two **mechanics-first** players, and they specifically miss the crunch that wasn't firing. **Two design implications.** (1) Like Sebastien, she wants mechanical resolution legible in **player-facing** surfaces — the same player-UI consideration, not a license for her name on OTEL/GM-panel/dev observability. (2) Uniquely, **Jade will author content** — genre packs, worlds, lore. She is a real user of the *authoring* surfaces (pack/world YAML, world-building tooling, the "Yes, And" collaborative-worldbuilding path), so mechanics the table wants should be expressible *in content*, not buried in engine code only Keith can touch. The 2026-05-25 SWN-crunch / ablative-HP reintroduction (`docs/superpowers/specs/2026-05-25-swn-crunch-ablative-hp-design.md`) is a direct response to Sebastien + Jade.
...
**Core Architecture (002, 003, 004, 005, 006, 007, 101, 115)**
- 002 SOUL Principles · 003 Genre Pack Architecture · 004 Lazy Genre Binding · 005 Background-First Pipeline · 006 Graceful Degradation · 007 Unified Character Model · 101 Anthropic SDK as Narrator Backend *(partial)* · 115 Persistence Substrate Migration — SQLite-Per-Session to PostgreSQL
